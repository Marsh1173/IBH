...
import { findDifference, Vector } from "../../Utils/2D/Vector";
...
export class BulletParticleHandler {
    public static makeBulletStreakParticle(game: Game, startPoint: Vector, endPoint: Vector) {
        ...
        let differenceVector: Vector = findDifference(startPoint, endPoint);
    ...
    public static makeBulletHitTerrainParticle(game: Game, startPoint: Vector, endPoint: Vector, edge: TerrainEdge) {
